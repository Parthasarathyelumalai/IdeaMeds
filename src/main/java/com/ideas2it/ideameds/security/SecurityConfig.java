...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/{id}/address/").hasAnyRole("CUSTOMER", "ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/perscription/add-to-cart/{userId}/{prescriptionId}").hasRole("CUSTOMER")
                ...
                .antMatchers(HttpMethod.GET, "/brand-item/get-all").hasAnyRole("CUSTOMER", "ADMIN")
                .antMatchers("/brand-item/**", "/medicineName/{medicineName}").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/brand-item/{brand-itemName}", "/medicineName/{medicineName}").hasRole("CUSTOMER")
                .antMatchers(HttpMethod.GET, "/brand-item").hasRole("CUSTOMER")
                .antMatchers("/warehouse", "/warehouse/**").hasRole("ADMIN")
                .antMatchers("/warehouse/warehouse-and-stocks/{warehouseId}").hasRole("ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/order", "/order/allorder").hasRole("ADMIN")
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
